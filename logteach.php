...
<html>
 ...
 <div class="row" style="padding-top:70px">
                   <div class="col-md-4 col-md-offset-4">
                       ...
                       <h2 class="text-center"><b>LOGIN FOR TEACHERS </h2>
       ...
       <div class="row">
                   <div class="col-md-7 col-md-offset-3">
                       <div class="panel panel-primary"  >
                           ...
                           <form action="register_teach.php" method="POST" role="form" >
               <h2 style="padding-left:10px"><b>SIGN UP</h2>
                 ...
                 <div class="input-group form-group" style="padding-left:10px;padding-right:10px;">
                               ...
                               <div class="input-group form-group" style="padding-left:10px;padding-right:10px;">
                                                 <span class="input-group-addon" id="basic-addon1"><i class="glyphicon glyphicon-user"></i></span>
                                                 <input type="number" name="id" class="form-control" placeholder="Enter your ID*" aria-describedby="basic-addon1" required>
                                             </div>
                               <div class="input-group form-group" style="padding-left:10px;padding-right:10px;">
